...
function getSwapBinaryInfo(): BinaryInfo {
  switch (process.platform) {
    case 'darwin':
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/preview/swap_preview_Darwin_x86_64.tar',
        sha256sum:
    ...
    case 'linux':
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/preview/swap_preview_Linux_x86_64.tar',
        sha256sum:
    ...
    default:
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/preview/swap_preview_Windows_x86_64.zip',
        sha256sum:
