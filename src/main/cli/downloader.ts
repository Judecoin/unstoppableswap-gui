...
function getSwapBinaryInfo(): BinaryInfo {
  switch (process.platform) {
    case 'darwin':
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/0.10.2/swap_0.10.2_Darwin_x86_64.tar',
        sha256sum:
    ...
    case 'linux':
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/0.10.2/swap_0.10.2_Linux_x86_64.tar',
        sha256sum:
          '3d3d701fd17a6c335bd80938204528c0c5a930041751fb66ff47a71893f1e5f1',
        name: 'swap',
      };
    default:
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/0.10.2/swap_0.10.2_Windows_x86_64.zip',
        sha256sum:
