...
function getActiveStep(
  ...
  if (dbState) {
    ...
    if (isMergedjudeLockProofReceivedDbState(dbState)) {
      return [1, processExited];
    }
    if (isMergedjudeLockedDbState(dbState)) {
    ...
    if (isMergedDonejudeRedeemedDbState(dbState)) {
      return [4, false];
    }

    // TODO: displays punish and refund as "Redeeming your jude"
