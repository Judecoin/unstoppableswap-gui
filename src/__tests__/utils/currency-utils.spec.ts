...
test('should compute correct jude mainnet txid blockexplorer url', () => {
  expect(
    ...
    'https://judechain.net/tx/cdcbef3d1e4653eda2ab67901d5e66d1d9fc7624079b2910b5c9aff58e954238'
  );
  ...
  expect(
    ...
    'https://judechain.net/tx/443bec12b0589ff9feb8e7fd8fb08c1a24d755e901b0d8a7197807613b9ff391'
  );
});
...
test('should compute correct jude testnet txid blockexplorer url', () => {
  expect(
    ...
    'https://stagenet.judechain.net/tx/59e02e88fca6edbdafbddb97a87dc6f616eae2059e44207918c6c9f91a261117'
  );
  ...
  expect(
    ...
    'https://stagenet.judechain.net/tx/a358cac3efacd939821977357acaa32f2d571bb332bf306376f35f2eb415ba1a'
  );
});
