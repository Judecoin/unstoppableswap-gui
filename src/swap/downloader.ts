...
function getSwapBinaryInfo(): BinaryInfo {
  switch (process.platform) {
    case 'darwin':
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/0.8.3/swap_0.8.3_Darwin_x86_64.tar',
        sha256sum:
    ...
    case 'linux':
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/0.8.3/swap_0.8.3_Linux_x86_64.tar',
        sha256sum:
    ...
    default:
      return {
        url: 'https://github.com/comit-network/jude-btc-swap/releases/download/0.8.3/swap_0.8.3_Windows_x86_64.zip',
        sha256sum:
